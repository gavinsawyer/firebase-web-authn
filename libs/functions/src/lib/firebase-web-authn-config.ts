/**
 * @property authenticatorAttachment - Passing "cross-platform" only allows security keys. Passing "platform" only allows passkey managers in the user's cloud or browser.
