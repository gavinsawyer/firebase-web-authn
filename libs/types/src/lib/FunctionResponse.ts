...
interface UnknownFunctionResponseSuccessful
...
interface ClearChallengeFunctionResponseSuccessful
  extends UnknownFunctionResponseSuccessful {
  "operation": "clear challenge";
}

interface ClearChallengeFunctionResponseUnsuccessful
...
interface ClearUserDocFunctionResponseSuccessful
  extends UnknownFunctionResponseSuccessful {
  "clearingCredential"?: WebAuthnUserCredentialFactor;
  "operation": "clear credential";
}

interface ClearUserDocFunctionResponseUnsuccessful
  extends UnknownFunctionResponseUnsuccessful {
...
interface CreateAuthenticationChallengeFunctionResponseSuccessful
  extends UnknownFunctionResponseSuccessful {
...
interface CreateAuthenticationChallengeFunctionResponseUnsuccessful
  extends UnknownFunctionResponseUnsuccessful {
...
interface CreateReauthenticationChallengeFunctionResponseSuccessful
  extends UnknownFunctionResponseSuccessful {
...
interface CreateRegistrationChallengeFunctionResponseSuccessful
  extends UnknownFunctionResponseSuccessful {
...
interface CreateRegistrationChallengeFunctionResponseUnsuccessful
  extends UnknownFunctionResponseUnsuccessful {
...
interface VerifyAuthenticationFunctionResponseSuccessful
  extends UnknownFunctionResponseSuccessful {
...
interface VerifyReauthenticationFunctionResponseSuccessful
  extends UnknownFunctionResponseSuccessful {
  "customToken": string;
...
interface VerifyRegistrationFunctionResponseSuccessful
  extends UnknownFunctionResponseSuccessful {
  "customToken": string;
...
type ClearChallengeFunctionResponse =
  ClearChallengeFunctionResponseSuccessful
  | ClearChallengeFunctionResponseUnsuccessful
type ClearUserDocFunctionResponse =
  ClearUserDocFunctionResponseSuccessful
  | ClearUserDocFunctionResponseUnsuccessful
type CreateAuthenticationChallengeFunctionResponse =
  CreateAuthenticationChallengeFunctionResponseSuccessful
  | CreateAuthenticationChallengeFunctionResponseUnsuccessful
type CreateReauthenticationChallengeFunctionResponse =
  CreateReauthenticationChallengeFunctionResponseSuccessful
  | CreateReauthenticationChallengeFunctionResponseUnsuccessful
type CreateRegistrationChallengeFunctionResponse =
  CreateRegistrationChallengeFunctionResponseSuccessful
  | CreateRegistrationChallengeFunctionResponseUnsuccessful
type VerifyAuthenticationFunctionResponse =
  VerifyAuthenticationFunctionResponseSuccessful
  | VerifyAuthenticationFunctionResponseUnsuccessful
type VerifyReauthenticationFunctionResponse =
  VerifyReauthenticationFunctionResponseSuccessful
  | VerifyReauthenticationFunctionResponseUnsuccessful
type VerifyRegistrationFunctionResponse =
  VerifyRegistrationFunctionResponseSuccessful
  | VerifyRegistrationFunctionResponseUnsuccessful

export declare type FunctionResponse =
  ClearChallengeFunctionResponse
  | ClearUserDocFunctionResponse
  | CreateAuthenticationChallengeFunctionResponse
  | CreateReauthenticationChallengeFunctionResponse
  | CreateRegistrationChallengeFunctionResponse
